...
# Railway healthcheck sends requests with Host: healthcheck.railway.app
# This must always be in ALLOWED_HOSTS for healthchecks to pass
...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="planify"),
        "USER": config("POSTGRES_USER", default="planify"),
        "PASSWORD": config("POSTGRES_PASSWORD", default="planify"),
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@planify.com")
